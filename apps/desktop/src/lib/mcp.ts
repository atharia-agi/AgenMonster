...
export const BROWSEROS_TOOLS = [
  ...
  'browseros.take_enhanced_snapshot',
  'browseros.take_screenshot',
  'browseros.click',
  'browseros.click_at',
  'browseros.double_click',
  'browseros.right_click',
  'browseros.fill',
  'browseros.clear',
  'browseros.select_option',
  'browseros.hover',
  'browseros.focus',
  'browseros.press_key',
  'browseros.scroll',
  'browseros.drag',
  'browseros.upload_file',
  'browseros.navigate',
  'browseros.go_back',
  'browseros.go_forward',
  'browseros.reload',
  'browseros.new_page',
  'browseros.new_hidden_page',
  'browseros.close_page',
  'browseros.show_page',
  'browseros.activate_window',
  'browseros.create_window',
  'browseros.create_hidden_window',
  'browseros.close_window',
  'browseros.list_pages',
  'browseros.list_windows',
  'browseros.list_tab_groups',
  'browseros.group_tabs',
  'browseros.ungroup_tabs',
  'browseros.move_page',
  'browseros.update_tab_group',
  'browseros.close_tab_group',
  'browseros.get_active_page',
  'browseros.get_page_content',
  'browseros.get_page_links',
  'browseros.get_dom',
  'browseros.search_dom',
  'browseros.evaluate_script',
  'browseros.handle_dialog',
  'browseros.check',
  'browseros.uncheck',
  'browseros.get_bookmarks',
  'browseros.create_bookmark',
  'browseros.update_bookmark',
  'browseros.move_bookmark',
  'browseros.remove_bookmark',
  'browseros.search_bookmarks',
  'browseros.get_recent_history',
  'browseros.search_history',
  'browseros.delete_history_url',
  'browseros.delete_history_range',
  'browseros.save_pdf',
  'browseros.save_screenshot',
  'browseros.download_file',
  'browseros.browseros_info',
  'browseros.discover_categories_or_actions',
  'browseros.get_category_actions',
  'browseros.get_action_details',
  'browseros.execute_action',
  'browseros.search_documentation',
  'browseros.handle_auth_failure',
  'browseros.suggest_app_connection',
  'browseros.suggest_schedule',
] as const;
