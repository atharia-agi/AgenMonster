...
pub const PALETTE_EGG: StagePalette = StagePalette {
    ...
    name: "Egg",
    colors: [
        "#0d1117", "#d2a8ff", "#58a6ff", "#e6edf3", "#484f58", "#f0e68c", "#ff6b6b",
    ],
};
...
pub const PALETTE_HATCHLING: StagePalette = StagePalette {
    ...
    name: "Hatchling",
    colors: [
        "#0d1117", "#7ee787", "#58a6ff", "#e6edf3", "#484f58", "#ffd700", "#ff6b6b",
    ],
};
...
pub const PALETTE_BABY: StagePalette = StagePalette {
    ...
    name: "Baby",
    colors: [
        "#0d1117", "#ff9a9e", "#a18cd1", "#e6edf3", "#484f58", "#fad0c4", "#ff6b6b",
    ],
};
...
pub const PALETTE_CHILD: StagePalette = StagePalette {
    ...
    name: "Child",
    colors: [
        "#0d1117", "#66d9ef", "#a6e22e", "#e6edf3", "#484f58", "#e6db74", "#ff6b6b",
    ],
};
...
pub const PALETTE_TEEN: StagePalette = StagePalette {
    ...
    name: "Teen",
    colors: [
        "#0d1117", "#ae81ff", "#f92672", "#e6edf3", "#484f58", "#a6e22e", "#ff6b6b",
    ],
};
...
pub const PALETTE_ADULT: StagePalette = StagePalette {
    ...
    name: "Adult",
    colors: [
        "#0d1117", "#e6db74", "#66d9ef", "#e6edf3", "#484f58", "#fd971f", "#ff6b6b",
    ],
};
...
pub const PALETTE_MEGA: StagePalette = StagePalette {
    ...
    name: "Mega",
    colors: [
        "#0d1117", "#ffd700", "#00ffff", "#e6edf3", "#484f58", "#ff6b6b", "#ff00ff",
    ],
};
