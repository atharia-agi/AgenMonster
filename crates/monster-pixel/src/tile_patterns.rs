...
pub struct TilePattern {
    pub name: &'static str,
    pub size: u32,
    pub pixels: Vec<Vec<bool>>, // tile grid
}
...
fn make_grass_blades() -> TilePattern {
    ...
    pixels[5][7] = true; pixels[6][7] = true;
...
fn make_heart_tile() -> TilePattern {
    ...
    pixels[3][1] = true; pixels[3][2] = true; pixels[3][3] = true; pixels[3][4] = true;
    pixels[3][5] = true; pixels[3][6] = true;
...
pub fn all_patterns() -> HashMap<&'static str, TilePattern> {
    ...
    let patterns: Vec<TilePattern> = vec![
        make_egg_dots(),
        make_grass_blades(),
        make_wave_crest(),
        make_mist_dots(),
