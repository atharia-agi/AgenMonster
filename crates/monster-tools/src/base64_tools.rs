...
impl Base64EncodeTool {
    ...
    pub fn name(&self) -> &str { "base64_encode" }
    pub fn description(&self) -> &str { "Encode a string to base64." }
...
impl Base64DecodeTool {
    pub fn new() -> Self { Self }
    pub fn name(&self) -> &str { "base64_decode" }
    pub fn description(&self) -> &str { "Decode a base64 string to text." }
    pub fn parameters(&self) -> Value {
        serde_json::json!({
            "type": "object",
            "properties": {
